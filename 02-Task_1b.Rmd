...
We can therefore say with 95% certainty that $\beta_{\text{height}}$ lies within the interval $(\hat{\beta_L}, \hat{\beta_H}) = (`r confint[1]`, `r confint[2]`)$.
